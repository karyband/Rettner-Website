...
class WC_Product {
	...
	public function single_add_to_cart_text() {
		return apply_filters( 'woocommerce_product_single_add_to_cart_text', __( 'Reserve', 'woocommerce' ), $this );
	}
	...
	public function get_availability() {
		...
		if ( $this->managing_stock() ) {
			...
			if ( $this->is_in_stock() && $this->get_total_stock() > get_option( 'woocommerce_notify_no_stock_amount' ) ) {
				...
				switch ( get_option( 'woocommerce_stock_format' ) ) {
					...
					case 'low_amount' :
						if ( $this->get_total_stock() <= get_option( 'woocommerce_notify_low_stock_amount' ) ) {
							$availability = sprintf( __( 'Available', 'woocommerce' ), $this->get_total_stock() );
					...
					default :
						$availability = sprintf( __( '%s Available', 'woocommerce' ), $this->get_total_stock() );
				...
				$availability = __( 'Unavailable but may be reserved.', 'woocommerce' );
