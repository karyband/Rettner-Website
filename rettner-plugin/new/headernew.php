 ...
 * Edited to have the University logo and Rettner logo
 *
 * @package storefront
 */
...
if ( ! function_exists( 'storefront_primary_navigation' ) ) {
	...
	function storefront_primary_navigation() {
		?>
		<div id="RettnerLogo"><img src="/wp_development/content/plugins/rettner-plugin/new/images/rettnerlogolarge.png"></div>
